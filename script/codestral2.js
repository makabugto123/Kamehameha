...
module.exports.config = {
  ...
  version: "1.0",
  credits: "Developer",
  description: "AI-powered coding assistant using Codestral Mamba",
  hasPrefix: false,
  usages: "{pn} [prompt]",
  aliases: [],
  cooldown: 0,
...
module.exports.run = async function ({ api, event, args }) {
  try {
    ...
    const response = await axios.get(`https://kaiz-apis.gleeze.com/api/codestral-mamba?q=${encodeURIComponent(prompt)}&uid=${uid}`);
