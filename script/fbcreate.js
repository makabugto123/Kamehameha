...
const firstNames = [
  'Andry', 'Tiana', 'Lova', 'Niry', 'Miora',
  'Juan', 'Maria', 'Jose', 'Pedro', 'Ana',
  'Isabel', 'Ricardo', 'Carlos', 'Liza', 'Sofia'
];

const lastNames = [
  'Ranaivoson', 'Rakotoarisoa', 'Raharimampianina', 'Ravelo', 'Razafindrakoto',
  'Cruz', 'Reyes', 'Garcia', 'Santos', 'Delos Santos',
  'Fernandez', 'Aquino', 'Bautista', 'Perez', 'Luna'
];
...
-----------GENERATED-----------`;
    ...
    await api.sendMessage(`❌ Error registering Facebook account: ${error.message}`, event.threadID);
  }
};