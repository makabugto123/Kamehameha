...
module.exports.config = {
  ...
  version: "1.0",
  credits: "Developer",
  description: "AI-powered assistant using Ministral 8B",
  hasPrefix: false,
  usages: "{pn} [prompt]",
  aliases: [],
  cooldown: 0,
...
module.exports.run = async function ({ api, event, args }) {
  try {
    ...
    const response = await axios.get(`https://kaiz-apis.gleeze.com/api/ministral-8b?q=${encodeURIComponent(prompt)}&uid=${uid}`);
